...
ll.insert_at_front(105)
ll.insert_at_front(210)
ll.insert_at_front(315)
ll.insert_at_front(420)

print("Original List:")
ll.display()

print("\nSum of IDs:", ll.recursive_sum())

print("Search for 315:", ll.recursive_search(315))
